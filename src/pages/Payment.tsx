...
const Payment = () => {
  ...
  const PROMO_CODES = [
    ...
    { code: 'SUMMER25', discount: 25 },  // 25% off
    { code: 'FREESHIP', discount: 99 },  // Free shipping (₹99 off)
  ];
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {promoApplied ? (
                      ...
                      <div className="flex space-x-2 mb-4">
                        ...
                        <Button 
                          ...
                          className="min-w-20 bg-indigo hover:bg-indigo-600"
                        >
                          Apply
                        </Button>
                      </div>
                  ...
                  <div className="mt-8">
                    <Button 
                      type="submit" 
                      className="w-full bg-indigo hover:bg-indigo-600 h-12 text-lg"
                      ...
                      <div className="border-t border-gray-100 pt-4 mt-4 space-y-2">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {orderDetails.total >= 599 || (promoApplied && promoApplied.code === 'FREESHIP') 
                              ? "Free" 
                              : "₹99"}
                          </span>
                        </div>
                        
                        {(promoApplied || (useLoyaltyPoints && pointsToUse > 0)) && (
