      ...
      <div className="bg-background border-b border-border">
        <div className="container-avirva">
          <div className="flex items-center justify-between py-3">
              ...
              <div className="text-center">
                <Link to="/" className="block">
                  <div className="flex flex-col items-center">
                    <img 
                      src="/lovable-uploads/73d6c4bf-342b-4d5b-ba2b-80e03f7dac00.png" 
                      alt="AVIRVA Logo" 
                      className="h-8 w-auto mb-1"
                    />
                    <div className="font-playfair text-lg font-bold tracking-wider text-foreground">
                      AVIRVA
                    </div>
                  </div>
                </Link>
            ...
            {/* Right side actions */}
            <div className="flex items-center space-x-3 flex-1 justify-end max-w-[200px]">
              {/* Search button */}
              <Button 
                variant="ghost" 
                size="icon" 
