    ...
    <div className="group bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
      <div className="relative">
        ...
        <div className="absolute top-2 left-2 space-y-1">
          {isNew && <Badge className="bg-[#5D3FD3] text-white dark:bg-[#5D3FD3]">New</Badge>}
          {isBestSeller && <Badge className="bg-[#9400D3] text-white dark:bg-[#9400D3]">Best Seller</Badge>}
        </div>
      ...
      <div className="p-4">
        <div onClick={handleProductClick} className="block cursor-pointer">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            {offerPrice && <span className="text-sm text-gray-400 line-through">₹{price}</span>}
            {offerPrice && <span className="text-xs text-green-600 dark:text-green-400 font-medium">
            ...
            <PopoverContent side="top" className="w-48 p-0" align="center">
              <div className="p-4">
                ...
                <div className="flex items-center justify-between border border-gray-200 dark:border-gray-600 rounded-md mb-3">
                  <button className="py-2 px-3 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700" onClick={handleDecreaseQuantity}>
                    <Minus className="h-4 w-4" />
                  </button>
                  <span className="font-medium">{quantity}</span>
                  <button className="py-2 px-3 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700" onClick={handleIncreaseQuantity}>
                ...
                <Button className="w-full bg-[#5D3FD3] hover:bg-[#4B32A5] dark:bg-[#5D3FD3] dark:hover:bg-[#4B32A5]" onClick={handleAddToCart}>
                  Add to Cart
                </Button>
              </div>
            </PopoverContent>
